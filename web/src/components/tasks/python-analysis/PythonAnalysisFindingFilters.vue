...
import type { PythonAnalysisSeverity } from '@/api/types'
import type { PythonAnalysisFilters } from '@/composables/usePythonAnalysis'

const props = defineProps<{
  filters: PythonAnalysisFilters
  disabled: boolean
}>()

const emit = defineEmits<{
  apply: [filters: PythonAnalysisFilters]
}>()

const cwe = shallowRef('')
const severity = shallowRef<PythonAnalysisSeverity>()
...
<template>
  <form class="finding-filters" aria-label="筛选 Python 源码检测结果" @submit.prevent="apply">
