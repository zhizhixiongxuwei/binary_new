...
import JavaAnalysisFindingFilters from '@/components/tasks/java-analysis/JavaAnalysisFindingFilters.vue'
import JavaAnalysisFindingTable from '@/components/tasks/java-analysis/JavaAnalysisFindingTable.vue'
import JavaAnalysisSummary from '@/components/tasks/java-analysis/JavaAnalysisSummary.vue'
import JavaAnalysisToolbar from '@/components/tasks/java-analysis/JavaAnalysisToolbar.vue'
...
<template>
  ...
  />
  <div v-else class="java-analysis-workspace">
    <JavaAnalysisToolbar
