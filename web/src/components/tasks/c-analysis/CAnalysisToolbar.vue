...
import type { CAnalysisRun, DecompileProject } from '@/api/types'
import { formatDateTime } from '@/utils/formatters'

defineProps<{
  projects: readonly DecompileProject[]
  runs: readonly CAnalysisRun[]
...
function runLabel(run: CAnalysisRun): string {
...
<template>
  <header class="analysis-toolbar">
    ...
    <div class="analysis-toolbar__actions" aria-label="C 源码检测操作">
      <el-button
        type="primary"
        :disabled="!canCreate"
        :loading="creating"
